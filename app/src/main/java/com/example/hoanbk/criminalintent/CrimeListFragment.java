...
public class CrimeListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // khong the su dung getListView()
        // boi vi no se tra ve null. chi khac null sau onCreateView
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            listView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
                ...
                public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
                    // Required, but no used in this implementation
                }

                @Override
                public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                    // goi khi tao tren actionBar
                    // dung de inflate menu can thiet vao actionBar
                ...
                public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
                    // dung de refresh lai menu cho them moi hay xoa di
                    return false;
                }
